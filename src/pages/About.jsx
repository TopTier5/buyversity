  ...
  <p>
    ...
    their academic and personal journey.
        ...
        <div className="bg-white mt-30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap- max-w-6xl mx-auto">
            <div className="flex flex-col items-center mt-20">
                ...
                <p className="text-gray-600 max-w-xs"> Shop student-priced gadgets like phones, laptops, game consoles, and accessories you can actually afford.</p>
            </div>
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <p className="text-gray-600 max-w-xs">From bedding, electric cookers to fans and mini fridges — everything you need to live comfortably in your hostel.</p>
            </div>
             ...
             <div className="flex flex-col items-center mt-20">
                ...
                <p className="text-gray-600 max-w-xs"> Buy or sell textbooks, handouts, and study guides from fellow students who have taken the course before you.</p>
            </div>
            </div>
        </div>


        <div style={{ backgroundColor: "#F6F6FE" }} className="pt-20 min-h-screen mt-40">
            <div className="text-center">
                <h3 className="text-4xl font-bold">Meet Our Team</h3>
                <div className="w-25 h-1 bg-gradient-to-r from-purple-600 to-blue-600 mx-auto rounded-full mt-5"></div>
                <p className="text-gray-600 text-xl mt-5">Students who understand your journey and are passionate about making <br />
                campus life more affordable for everyone.</p>
            </div>
